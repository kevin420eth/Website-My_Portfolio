    ...
    return (
        <header className='header'>
            <nav className='nav container'>
                <a href='https://kevmars.com' className='nav__logo'>Kevin Mars</a>
                ...
                <div className={`nav__menu ${Toggle ? 'show-menu' : ''}`}>
                    <ul className='nav__list grid'>
                        ...
                        <li className='nav__item'>
                            <a href='#services' className='nav__link'><BsBriefcase className='nav__icon' /> Services</a>
                        </li>

                        <li className='nav__item'>
                            <a href='#qualification' className='nav__link'><BiPhotoAlbum className='nav__icon' /> Qualification</a>
                        </li>
