...
const Data = ()=>{
    return(
        <div className='home__data'>
            <h1 className='home__title'>Kevin Mars
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <p className='home__description'>Patrick didn't want to go. The fact that she was insisting 
            they must go made him want to go even less.
            </p>
